...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = mx
        ? ["a1-why-mcp.html", "a2-architecture-plain.html",
           "a3-ecosystem-play.html", "a4-security-trust.html",
           "a5-mcp-in-your-org.html", "a6-roadmap.html"]
        : ["b1-what-mcp-is.html", "b2-first-server.html", "b3-resources-prompts.html",
           "b4-connect-hosts.html", "b5-build-a-client.html",
           "b6-remote-servers.html", "b7-auth-security.html", "b8-registry-whats-next.html"];
